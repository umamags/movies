...
function processFolder(folderConfig) {
  ...
  try {
    ...
    console.log(`Mode: ${updateMode ? 'UPDATE' : 'LIST'}`);
...
// Display usage info
function showUsage() {
  console.log('\n📋 Timestamp Utility (Using Photo/Video Metadata)');
  console.log('==================================================\n');
  console.log('Usage: node utils/timestamps.js [<folder-title>] [--update|--remove] [--all]\n');
  console.log('Options:');
  console.log('  (no arguments)     - Process all folders with run=yes');
  console.log('  <folder-title>     - Process specific folder (e.g., "wayanad" or "Cancun")');
  ...
  console.log('\nMetadata extraction:');
  console.log('  • JPG/PNG: EXIF DateTimeOriginal (photo capture time)');
  console.log('  • HEIC: exiftool DateTimeOriginal, then Spotlight metadata');
  console.log('  • Videos: ffprobe creation_time from video metadata');
  console.log('  • Fallback: File system creation time\n');
  console.log('Examples:');
  console.log('  node utils/timestamps.js                    # List timestamps, all enabled folders');
  console.log('  node utils/timestamps.js Cancun             # List timestamps for "Cancun"');
  console.log('  node utils/timestamps.js Cancun --update    # Add/update timestamps on "Cancun" files');
  console.log('  node utils/timestamps.js Cancun --remove    # Strip timestamps from "Cancun" files');
  console.log('  node utils/timestamps.js --all --update     # Update timestamps on all folders\n');
}
